...
Sub ShowRebootNotice
    Dim message
    message = "No reboot is needed when installing, upgrading, or uninstalling Nimbus." & vbCrLf & vbCrLf & _
              "Nimbus uses an MSI installer, which enables seamless in-place upgrades and unattended installs." & vbCrLf & _
