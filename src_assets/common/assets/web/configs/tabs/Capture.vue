...
const losslessStatusHint = computed(() => {
  ...
  return 'Nimbus could not find Lossless Scaling. Scan for an installation or provide the executable path below.';
});
    ...
    >
      <div class="space-y-4">
        <n-alert type="info" size="small" v-if="!losslessCandidates.length">
          Nimbus searched common Steam and program directories but could not locate
