...
const resources = computed(() => [
  ...
  {
    href: 'https://github.com/kunolabs/Nimbus/discussions',
    icon: 'fab fa-github',
  ...
  {
    href: 'https://github.com/kunolabs/Nimbus/issues',
    icon: 'fab fa-github',
    title: 'GitHub Issues',
...
const legalLinks = computed(() => [
  {
    href: 'https://github.com/kunolabs/Nimbus/blob/master/LICENSE',
  ...
  {
    href: 'https://github.com/kunolabs/Nimbus/blob/master/NOTICE',
